...
import com.alkemy.springboot.app.dto.Role;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) throws UserAlreadyExistException {
        ...
        String token = userService.userSignUp(new User(request.getEmail(), request.getPassword(), Role.USER));

        String link = "http://localhost:1414/auth/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
